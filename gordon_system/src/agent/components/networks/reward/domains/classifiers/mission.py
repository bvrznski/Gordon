# Multi-Domain Reward Engine - Mission Classifier (Phase 4.10.5)
# ===============================================================

"""
MissionRewardClassifier for Phase 4.10.5.

This classifier identifies mission reward: rewards that evaluate alignment with
long-term objectives, architectural integrity, system objectives, and persistent
commitments.
"""
...
class MissionRewardClassifier(BaseRewardClassifier):
    """
    Classify rewards as mission-related (long-term alignment).
    ...
    def classify(
        ...
        """
        Classify rewards as mission-related.
        ...
        for estimate in reward_estimates:
            ...
            is_mission = any(indicator in text_context for indicator in mission_indicators)
        ...
        if not supporting_estimates:
            findings.append("NO_MISSION_INDICATORS_FOUND")
            return ClassifierResult(
        ...
        findings.append(f"FOUND_{len(supporting_estimates)}_MISSION_ESTIMATES")
