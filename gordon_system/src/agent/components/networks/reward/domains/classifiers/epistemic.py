# Multi-Domain Reward Engine - Epistemic Classifier (Phase 4.10.5)
# ================================================================

"""
EpistemicRewardClassifier for Phase 4.10.5.

This classifier identifies epistemic reward: rewards that originate from
knowledge acquisition, uncertainty reduction, model improvement, and hypothesis
validation.
"""
...
class EpistemicRewardClassifier(BaseRewardClassifier):
    """
    Classify rewards as epistemic (knowledge-related).
    ...
    def classify(
        ...
        for estimate in reward_estimates:
            ...
            is_epistemic = any(indicator in text_context for indicator in epistemic_indicators)
        ...
        if not supporting_estimates:
            findings.append("NO_EPISTEMIC_INDICATORS_FOUND")
            return ClassifierResult(
        ...
        findings.append(f"FOUND_{len(supporting_estimates)}_EPISTEMIC_ESTIMATES")
