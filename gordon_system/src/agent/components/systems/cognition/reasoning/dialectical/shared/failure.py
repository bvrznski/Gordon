# Dialectical Failure - Phase 7.17
# ================================

"""
Canonical Dialectical Failure Contract.

Dialectical Failures record when dialectics cannot complete.
"""
...
class DialecticalFailure:
    """
    A dialectical failure with diagnostic information.
    ...
    def create(
        ...
        return cls(
            failure_id=f"dialectical_failure:{uuid.uuid4().hex[:16]}",
    ...
    def with_diagnostic(self, key: str, value: Any) -> DialecticalFailure:
