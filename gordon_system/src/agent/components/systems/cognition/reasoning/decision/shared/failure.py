# Decision Failure - Phase 7.19
# ===========================

"""
Canonical Decision Failure Contract.

Decision Failures record when decision cannot complete.
"""
...
class DecisionFailure:
    """
    A decision failure with diagnostic information.
    ...
    def create(
        ...
        return cls(
            failure_id=f"decision_failure:{uuid.uuid4().hex[:16]}",
    ...
    def with_diagnostic(self, key: str, value: Any) -> DecisionFailure:
