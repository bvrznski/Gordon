# Memory Provenance - Phase 5.1 Canonical Origin Tracking
# ========================================================

"""
Memory Provenance: Complete origin tracking for memory artifacts.

Every MemoryArtifact preserves provenance:
...
Provenance Laws:
    PROVENANCE-LAW-001: Every artifact has complete provenance
...
class MemoryProvenance:
    ...
    # Supporting evidence
    supporting_sources: Tuple[MemoryProvenanceSource, ...] = field(
    ...
    def extend(
        ...
        Returns:
            New MemoryProvenance with updated lineage
        """
    ...
    def with_revision_identity(self, revision_id: str) -> "MemoryProvenance":
        """Add a revision identity to the lineage."""
        new_lineage = (revision_id,) + self.revision_lineage
        return dataclass_replace(self, revision_lineage=new_lineage)
    ...
    def from_observation(
        ...
        """
        Create provenance for an observed artifact.
        ...
        Returns:
            New MemoryProvenance with observation context
        """
        return cls(
            ...
            supporting_sources=(
                MemoryProvenanceSource(
                    ...
                    source_location=source_location or "memory",
                    confidence=1.0,
                ),
    ...
    def from_inference(
        ...
        """
        Create provenance for an inferred artifact.
        ...
        Returns:
            New MemoryProvenance with inference context
        """
        return cls(
...
# =============================================================================
# MEMORY PROVENANCE BUILDER
# =============================================================================


class MemoryProvenanceBuilder:
    """
    ...
    def __init__(self):
        ...
        self._supporting_sources: List[MemoryProvenanceSource] = []
    ...
    def set_origin(self, origin: str) -> "MemoryProvenanceBuilder":
        """Set the primary source."""
        self._origin = origin
        return self
    
    def set_originating_system(self, system: str) -> "MemoryProvenanceBuilder":
        """Set the originating system."""
        self._originating_system = system
        return self
    
    def set_creation_process(self, process: str) -> "MemoryProvenanceBuilder":
        """Set how the artifact was created."""
    ...
    def set_direct_evidence(self, evidence: str) -> "MemoryProvenanceBuilder":
        """Set direct evidence reference."""
        self._direct_evidence = evidence
        return self
    
    def add_transformation(self, transformation: str) -> "MemoryProvenanceBuilder":
        """Record a transformation applied to this artifact."""
        self._transformation_history.append(transformation)
        return self
    
    def add_to_lineage(self, revision_id: str) -> "MemoryProvenanceBuilder":
        """Add to the revision lineage."""
        self._revision_lineage.insert(0, revision_id)
        return self
    
    def set_previous_revision(self, prev_id: str) -> "MemoryProvenanceBuilder":
        """Set the previous revision ID."""
        self._previous_revision_id = prev_id
        return self
    
    def set_semantic_time(self, timestamp_utc: float) -> "MemoryProvenanceBuilder":
        """Set semantic time (when it became meaningful)."""
        self._semantic_time_utc = timestamp_utc
        return self
    
    def set_created_at(self, timestamp_utc: float) -> "MemoryProvenanceBuilder":
        """Set creation timestamp."""
        self._created_at_utc = timestamp_utc
        return self
    
    def set_change_reason(self, reason: str) -> "MemoryProvenanceBuilder":
        """Set the change reason."""
        self._change_reason = reason
        return self
    
    def set_changed_by(self, changer: str) -> "MemoryProvenanceBuilder":
        """Set who made the change."""
        self._changed_by = changer
        return self
    
    def set_validation_status(self, status: str) -> "MemoryProvenanceBuilder":
        """Set validation status."""
        self._validation_status = status
        return self
    
    def build(self) -> MemoryProvenance:
        """
        Build an immutable MemoryProvenance.
        
        Returns:
            New MemoryProvenance with all settings applied
        """
...
def dataclass_replace(instance: MemoryProvenance, **kwargs) -> MemoryProvenance:
