# Knowledge Uncertainty - Phase 6.1
# ================================
...
# =============================================================================
# SEMANTIC UNCERTAINTY - Core representation
# =============================================================================
...
class SemanticUncertainty:
    ...
    Fields:
        ...
        kind:                  Kind of uncertainty (semantic, evidential, etc.)
    ...
    def create(
        ...
        Returns:
            New SemanticUncertainty instance
        """
        return cls(
    ...
    def update(
        ...
        Returns:
            Updated SemanticUncertainty instance
        """
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "SemanticUncertainty":
...
# =============================================================================
# UNCERTAINTY AGGREGATOR - Combine multiple uncertainty metrics
# =============================================================================
...
class UncertaintyAggregator:
    ...
    def aggregate(
        ...
        Returns:
            Aggregated SemanticUncertainty record
        """
        if len(uncertainties) < self._min_sources:
            return SemanticUncertainty.create(0.5)
        ...
        return SemanticUncertainty.create(
            value=aggregated_value,
            sources=sources,
        )
    
    def aggregate_uncertainty_records(
        self,
