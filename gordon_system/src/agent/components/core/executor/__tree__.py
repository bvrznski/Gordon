...
"""
Package Contract:
- Package must exist at g Gordon.system.src.agent.components.core.executor
...
class Node:
    """Node in the executor tree structure."""
...
executor_tree = Node("executor")


def get_structure() -> Dict[str, object]:
    return executor_tree.to_dict()


package_path = "gordon.system.src.agent.components.core.executor"
parent_package = "g Gordon.system.src.agent.components.core"
allowed_children = []
required_children = []
required_files = ["__init__.py", "__meta__.py", "__tree__.py"]
forbidden_children = []
ownership_boundary = "g Gordon.system.src.agent.components.core.executor.*"
...
__all__ = ["Node", "executor_tree", "get_structure", "get_contract", "package_path",
