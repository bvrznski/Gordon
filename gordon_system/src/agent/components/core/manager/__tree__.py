...
"""
Package Contract:
- Package must exist at g Gordon.system.src.agent.components.core.manager
...
class Node:
    """Node in the manager tree structure."""
...
manager_tree = Node("manager")


def get_structure() -> Dict[str, object]:
    return manager_tree.to_dict()


package_path = "gordon.system.src.agent.components.core.manager"
parent_package = "g Gordon.system.src.agent.components.core"
allowed_children = []
required_children = []
required_files = ["__init__.py", "__meta__.py", "__tree__.py"]
forbidden_children = []
ownership_boundary = "g Gordon.system.src.agent.components.core.manager.*"
...
__all__ = ["Node", "manager_tree", "get_structure", "get_contract", "package_path",
