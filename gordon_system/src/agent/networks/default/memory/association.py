...
"""
Immutable association and relationship models for memory records.
...
class MemoryAssociation:
    """
    Immutable association between memory records or semantic entities.
    
    An association describes a semantic relationship without implying
    causal truth. Associations may be:
    ...
    PROPERTIES:
        ...
        • kind: Association kind (AssociationKind.*)
        • evidence: Supporting evidence references
        • confidence: Confidence in the association (0.0 to 1.0)
        • directionality: Is this directional?
        • factuality: Factuality of the associative claim
        • provenance: Provenance reference
        
    IS NOT:
        - Causal truth (just an observed relationship)
        - A structural link (may become one if validated)
    ...
    target_entity: str
    """Reference to the target entity or memory."""
    
    # Association details
    kind: str  # AssociationKind.*
    ...
    """Confidence in the association (0.0 to 1.0)."""
    
    directionality: str = "symmetric"
    """Is this bidirectional? 'symmetric' or 'directional'."""
    
    factuality: str = "unknown"
    """Factuality of the associative claim."""
    
    provenance: Optional[str] = None
    """Provenance reference (how this association was created)."""
    ...
    def new(
        ...
        return cls(
            association_id=f"association_{id(cls)}",
    ...
    def is_directional(self) -> bool:
        ...
        return self.directionality == "directional"
