...
This file defines the structural contract for the topology module.
...
1. Package must exist at gordon.system.src.agent.architecture.topology
...
class Node:
    """Node in the topology tree structure."""
...
# Topology is a leaf node (no children)
topology_tree = Node("topology")


def get_structure() -> Dict[str, object]:
    """Return the topology structure."""
    return topology_tree.to_dict()


# Contract properties for validation
package_path = "gordon.system.src.agent.architecture.topology"
parent_package = "gordon.system.src.agent.architecture"
allowed_children = []
required_children = []
required_files = ["__init__.py", "__meta__.py", "__tree__.py"]
forbidden_children = []
ownership_boundary = "gordon.system.src.agent.architecture.topology.*"
...
__all__ = [
    "Node",
    "topology_tree", "get_structure", "get_contract",
    # Contract properties
