...
This file defines the structural contract for the dependency graph module.
...
1. Package must exist at gordon.system.src.agent.architecture.dependency_graph
...
class Node:
    """Node in the dependency graph tree structure."""
...
# Dependency graph is a leaf node (no children)
dependency_graph_tree = Node("dependency_graph")


def get_structure() -> Dict[str, object]:
    """Return the dependency graph structure."""
    return dependency_graph_tree.to_dict()


# Contract properties for validation
package_path = "gordon.system.src.agent.architecture.dependency_graph"
parent_package = "gordon.system.src.agent.architecture"
allowed_children = []
required_children = []
required_files = ["__init__.py", "__meta__.py", "__tree__.py"]
forbidden_children = []
ownership_boundary = "gordon.system.src.agent.architecture.dependency_graph.*"
...
__all__ = [
    "Node",
    "dependency_graph_tree", "get_structure", "get_contract",
    # Contract properties
