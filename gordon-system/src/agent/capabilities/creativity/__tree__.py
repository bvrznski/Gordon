...
"""
Package Contract:
- Package must exist at gordon.system.src.agent.capabilities.creativity
...
class Node:
    """Node in the creativity tree structure."""
...
creativity_tree = Node("creativity")


def get_structure() -> Dict[str, object]:
    return creativity_tree.to_dict()


package_path = "gordon.system.src.agent.capabilities.creativity"
parent_package = "gordon.system.src.agent.capabilities"
allowed_children = []
required_children = []
required_files = ["__init__.py", "__meta__.py", "__tree__.py"]
forbidden_children = []
ownership_boundary = "gordon.system.src.agent.capabilities.creativity.*"
...
__all__ = ["Node", "creativity_tree", "get_structure", "get_contract", "package_path",
