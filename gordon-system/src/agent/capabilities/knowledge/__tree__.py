...
"""
Package Contract:
- Package must exist at gordon.system.src.agent.capabilities.knowledge
...
class Node:
    """Node in the knowledge tree structure."""
...
knowledge_tree = Node("knowledge")


def get_structure() -> Dict[str, object]:
    return knowledge_tree.to_dict()


package_path = "gordon.system.src.agent.capabilities.knowledge"
parent_package = "gordon.system.src.agent.capabilities"
allowed_children = []
required_children = []
required_files = ["__init__.py", "__meta__.py", "__tree__.py"]
forbidden_children = []
ownership_boundary = "gordon.system.src.agent.capabilities.knowledge.*"
...
__all__ = ["Node", "knowledge_tree", "get_structure", "get_contract", "package_path",
