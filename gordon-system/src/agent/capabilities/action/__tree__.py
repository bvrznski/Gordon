# Tree: Action Structure
# ========================

"""
Package Contract:

This file defines the structural contract for the action module.
...
1. Package must exist at gordon.system.src.agent.capabilities.action
...
class Node:
    """Node in the action tree structure."""
...
# Action is a leaf node (no children)
action_tree = Node("action")


def get_structure() -> Dict[str, object]:
    """Return the action structure."""
    return action_tree.to_dict()


# Contract properties for validation
package_path = "gordon.system.src.agent.capabilities.action"
parent_package = "gordon.system.src.agent.capabilities"
allowed_children = []
required_children = []
required_files = ["__init__.py", "__meta__.py", "__tree__.py"]
forbidden_children = []
ownership_boundary = "gordon.system.src.agent.capabilities.action.*"
...
__all__ = [
    "Node",
    "action_tree", "get_structure", "get_contract",
    # Contract properties
