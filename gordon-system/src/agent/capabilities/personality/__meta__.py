# Meta: Personality Module
# =========================

"""
Architectural Identity:
- Canonical Name: Personality
...
Purpose:
The personality module provides consistent behavioral patterns and traits.
It enables the agent to have distinctive characteristics and response styles.
...
name = "Personality"
description = "Consistent behavioral patterns and traits"
version = "0.0.1"

canonical_name = "gordon.system.src.agent.capabilities.personality"
layer = 1
