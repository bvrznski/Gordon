...
"""
Package Contract:
- Package must exist at gordon.system.src.agent.capabilities.evolution
...
class Node:
    """Node in the evolution tree structure."""
...
evolution_tree = Node("evolution")


def get_structure() -> Dict[str, object]:
    return evolution_tree.to_dict()


package_path = "gordon.system.src.agent.capabilities.evolution"
parent_package = "gordon.system.src.agent.capabilities"
allowed_children = []
required_children = []
required_files = ["__init__.py", "__meta__.py", "__tree__.py"]
forbidden_children = []
ownership_boundary = "gordon.system.src.agent.capabilities.evolution.*"
...
__all__ = ["Node", "evolution_tree", "get_structure", "get_contract", "package_path",
