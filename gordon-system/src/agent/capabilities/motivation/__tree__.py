# Tree: Motivation Structure
# =============================

"""
Package Contract:
- Package must exist at gordon.system.src.agent.capabilities.motivation
...
class Node:
    """Node in the motivation tree structure."""
...
motivation_tree = Node("motivation")


def get_structure() -> Dict[str, object]:
    return motivation_tree.to_dict()


package_path = "gordon.system.src.agent.capabilities.motivation"
parent_package = "gordon.system.src.agent.capabilities"
allowed_children = []
required_children = []
required_files = ["__init__.py", "__meta__.py", "__tree__.py"]
forbidden_children = []
ownership_boundary = "gordon.system.src.agent.capabilities.motivation.*"
...
__all__ = ["Node", "motivation_tree", "get_structure", "get_contract", "package_path",
